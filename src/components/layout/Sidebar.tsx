...
import { Library, ClipboardList, HelpCircle, ChevronLeft, ChevronRight } from "lucide-react";
...
const navItems: NavItem[] = [
  { label: "Operaciones", icon: ClipboardList, id: "operaciones" },
  { label: "Librerías", icon: Library, id: "librerias" },
];
