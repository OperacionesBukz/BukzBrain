        ...
        {modules.map((module) => {
          ...
          return (
            <button
              ...
              className="group bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden border-2 border-gray-200 hover:border-gray-300 text-left w-full aspect-square"
            >
              {/* Card Content */}
              <div className="flex flex-col items-center justify-center text-center p-8 space-y-4 h-full">
                ...
                <div className="w-full flex items-center justify-center">
                  <div className="relative">
                    ...
                    <div className="bg-gray-50 rounded-xl p-6 group-hover:bg-gray-100 transition-colors duration-300">
                      <Icon className="h-16 w-16 text-gray-900 stroke-[1]" />
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-2 w-full">
                  ...
                  {/* Button */}
                  <div className="pt-2">
                    <div className="inline-flex items-center justify-center bg-gray-900 text-white font-medium px-5 py-2 text-sm rounded-lg transition-all duration-200 group-hover:bg-gray-800">
                      Ver más
                    </div>
                  </div>
                </div>
